...
$dis = $_POST['dis'];
$sql = "INSERT INTO post ( tittle, catagary, img, descripton, admn)
VALUES ('$tittle', '$cat ', '$folder','$dis', '$admin')";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="admin">
                                        </div>
                                    </div>
    ...
    <select class="form-control" id="exampleFormControlSelect1"  name="cat">
      ...
      <option value="Wordpress development">Wordpress development</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line"  name = "dis"></textarea>
                                        </div>
                                    </div>
                                  
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" name="submit">Add New  post </button>
                                        </div>
                                    </div>
                                </form>
                    </div>
