...
$sql = "INSERT INTO team (img, 	name , designation)
VALUES ('$folder', '$name', '$desgntion')";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="desgntion"></textarea>
                                        </div>
                                    </div>
                                  
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" name="submit">Add New  Member </button>
                                        </div>
                                    </div>
                                </form>
                    </div>
