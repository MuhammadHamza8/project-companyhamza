...
$edittittle = $_POST['edittittle'];
$editadmin = $_POST['editadmin'];
$editcat= $_POST['editcat'];
$editdis = $_POST['editdis'];
...
$sql = "UPDATE post  SET tittle='$edittittle', 	catagary = '$editcat' ,	img ='$folder',  descripton ='$editdis', admn='$editadmin'  WHERE id='$edit_id' ";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data" >
                                    <div class="form-group">
                                        <label class="col-md-12">Post Tittle</label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="edittittle" value=" <?php echo $tittle; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Posted By</label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editadmin" value="<?php  echo  $admn; ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
    <label for="exampleFormControlSelect1"> select Catagory</label>
    <select class="form-control" id="exampleFormControlSelect1"  name="editcat" >
      <option value="Grapic design" >Grapic design</option>
      <option value="Digital Marketing">Digital Marketing</option>
      <option value="We bdevelopment">We bdevelopment</option>
      ...
      <option value="Wordpress development">Wordpress development</option>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Post   Description </label>
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line"  name = "editdis" ><?php  echo $descripton; ?></textarea>
                                        </div>
                                    </div>
                ...
                <div class="row">
                   <!--my table-->
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Total Number of Posts  </h4>
  ...
  while($row = mysqli_fetch_assoc($result)) {?>
                                        ...
                                        <tr>
                                           ...
                                           <td><?php echo $row['admn'];?></td>
                                            <td><a href="editpost.php?edit_id=<?php echo $row['id'];?>"> Edite </a>
                                               <a href="deletepost.php?delete_id=<?php echo $row['id'];?>" >|| DELETE  </a>  <td>
                                        </tr>
  <?php } ?>
