...
$editename = $_POST['editename'];

$editedesgntion = $_POST['editedesgntion'];
...
$sql = "UPDATE team SET name='$editename', designation = '$editedesgntion' ,	img ='$folder'  WHERE id='$edit_id' ";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editename" value="<?php echo $name; ?>" >
                                        </div>
                                    </div>
                                   
                                  
                                    <div class="form-group">
                                        <label class="col-md-12">Member  image </label>
                                        <div class="col-md-12">
                                            <input type="file"  class="form-control form-control-line" name="img">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Member  Designation </label>
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="editedesgntion"  > <?php echo  $desgntion ?>
                                            </textarea>
                                        </div>
                                    </div>
                ...
                <div class="row">
                   <!--my table-->
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Total Number of Member </h4>
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edite.php?edit_id=<?php echo $row['id'];?>"> Edite </a>
                                               <a href="delete.php?delete_id=<?php echo $row['id'];?>" >|| DELETE  </a>  <td>
                                        </tr>
  <?php } ?>
