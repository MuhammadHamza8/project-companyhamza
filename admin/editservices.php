...
$editetittle = $_POST['editetittle'];

$editecontent = $_POST['editecontent'];
...
$sql = "UPDATE services SET tittle='$editetittle', content	 = ' $editecontent' ,	img ='$folder'  WHERE id='$edit_id' ";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editetittle" value="<?php echo  $tittle; ?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12"> Service discription  </label>
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="editecontent"  > <?php echo   $content ?>
                                            </textarea>
                                        </div>
                                    </div>
